...
(* OASIS_START *)
(* DO NOT EDIT (digest: 01b8414ab8a899b4fa645489434bd628) *)
(*
...
# 21 "/home/gildor/programmation/oasis/src/plugins/none/NonePlugin.ml"
...
let setup_t =
  {
       ...
       [
          ...
          ("proto_oasis",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$proto_oasis", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
       ];
     doc =
       [
          ("api-debian-formats",
            NonePlugin.not_implemented "doc of section api-debian-formats")
       ];
            ...
            [
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mikmatch_pcre", None)
                        ];
                      bs_build_tools =
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/debian-formats";
                      doc_title = "API reference for DebianFormats";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "debian-formats";
               ...
               Test
                 ({
                     ...
                     },
                   {
                      ...
                      test_working_directory = Some "test/data";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build and test examples";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("archive.lwt", None);
                           FindlibPackage ("oasis", None);
                           FindlibPackage ("bz2", None);
                   ...
                   {exec_custom = false; exec_main_is = "proto_oasis.ml"; });
               Test
                 ({
                     cs_name = "proto_oasis";
                     cs_data = PropList.Data.create ();
                     ...
                     },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "proto_oasis"
                        ];
                      })
            ];
          plugins =
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "7=m\001z\n@Q\000\170o\189r\236(S";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
